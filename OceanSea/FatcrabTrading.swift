...
public class Trader: TraderProtocol {
    ...
    public convenience init(info: BlockchainInfo) {
        self.init(unsafeFromRawPointer: try! rustCall {
            uniffi_fatcrab_trading_fn_constructor_trader_new(
                FfiConverterTypeBlockchainInfo.lower(info), $0
            )
        })
    }
    ...
    public static func newWithKeys(key: String, info: BlockchainInfo) -> Trader {
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_fatcrab_trading_checksum_constructor_trader_new() != 31493 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_fatcrab_trading_checksum_constructor_trader_new_with_keys() != 10947 {
        return InitializationResult.apiChecksumMismatch
    }
