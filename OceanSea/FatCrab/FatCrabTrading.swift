    ...
    FatCrabTraderProtocol
{
    ...
    public func getNetwork() -> Network {
        return try! FfiConverterTypeNetwork.lift(
            try!
                rustCall {
                    uniffi_fatcrab_trading_fn_method_fatcrabtrader_get_network(self.uniffiClonePointer(), $0)
                }
        )
    }
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_fatcrab_trading_checksum_method_fatcrabtrader_get_network() != 42243 {
        return InitializationResult.apiChecksumMismatch
    }
