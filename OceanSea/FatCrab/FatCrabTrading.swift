    ...
    FatCrabBuyMakerProtocol
{
    ...
    open func cancelOrder() throws -> FatCrabMakerState {
        return try FfiConverterTypeFatCrabMakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuymaker_cancel_order(self.uniffiClonePointer(), $0)
        })
    }

    open func getOrderDetails() throws -> FatCrabOrder {
        return try FfiConverterTypeFatCrabOrder.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuymaker_get_order_details(self.uniffiClonePointer(), $0)
        })
    }

    open func getPeerPubkey() throws -> String? {
        return try FfiConverterOptionString.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuymaker_get_peer_pubkey(self.uniffiClonePointer(), $0)
        })
    }

    open func getState() throws -> FatCrabMakerState {
        return try FfiConverterTypeFatCrabMakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuymaker_get_state(self.uniffiClonePointer(), $0)
        })
    }

    open func postNewOrder() throws -> FatCrabMakerState {
        return try FfiConverterTypeFatCrabMakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuymaker_post_new_order(self.uniffiClonePointer(), $0)
        })
    }

    open func queryOffers() throws -> [FatCrabOfferEnvelope] {
        return try FfiConverterSequenceTypeFatCrabOfferEnvelope.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuymaker_query_offers(self.uniffiClonePointer(), $0)
        })
    }

    open func queryPeerMsg() throws -> FatCrabPeerEnvelope? {
        return try FfiConverterOptionTypeFatCrabPeerEnvelope.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuymaker_query_peer_msg(self.uniffiClonePointer(), $0)
        })
    }

    open func registerNotifDelegate(delegate: FatCrabMakerNotifDelegate) throws { try rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func releaseNotifyPeer() throws -> FatCrabMakerState {
        return try FfiConverterTypeFatCrabMakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuymaker_release_notify_peer(self.uniffiClonePointer(), $0)
        })
    }

    open func tradeComplete() throws -> FatCrabMakerState {
        return try FfiConverterTypeFatCrabMakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuymaker_trade_complete(self.uniffiClonePointer(), $0)
        })
    }

    open func tradeResponse(tradeRspType: FatCrabTradeRspType, offerEnvelope: FatCrabOfferEnvelope) throws -> FatCrabMakerState {
        return try FfiConverterTypeFatCrabMakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func unregisterNotifDelegate() throws { try rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    FatCrabBuyTakerProtocol
{
    ...
    open func checkBtcTxConfirmation() throws -> UInt32 {
        return try FfiConverterUInt32.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuytaker_check_btc_tx_confirmation(self.uniffiClonePointer(), $0)
        })
    }

    open func getOrderDetails() throws -> FatCrabOrderEnvelope {
        return try FfiConverterTypeFatCrabOrderEnvelope.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuytaker_get_order_details(self.uniffiClonePointer(), $0)
        })
    }

    open func getPeerBtcTxid() throws -> String? {
        return try FfiConverterOptionString.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuytaker_get_peer_btc_txid(self.uniffiClonePointer(), $0)
        })
    }

    open func getState() throws -> FatCrabTakerState {
        return try FfiConverterTypeFatCrabTakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuytaker_get_state(self.uniffiClonePointer(), $0)
        })
    }

    open func notifyPeer(fatcrabTxid: String) throws -> FatCrabTakerState {
        return try FfiConverterTypeFatCrabTakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func queryTradeRsp() throws -> FatCrabTradeRspEnvelope? {
        return try FfiConverterOptionTypeFatCrabTradeRspEnvelope.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuytaker_query_trade_rsp(self.uniffiClonePointer(), $0)
        })
    }

    open func registerNotifDelegate(delegate: FatCrabTakerNotifDelegate) throws { try rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func takeOrder() throws -> FatCrabTakerState {
        return try FfiConverterTypeFatCrabTakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabbuytaker_take_order(self.uniffiClonePointer(), $0)
        })
    }

    open func tradeComplete() throws -> FatCrabTakerState {
        return try FfiConverterTypeFatCrabTakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
...
open class FatCrabMakerNotifDelegateImpl:
    FatCrabMakerNotifDelegate
{
    ...
    open func onMakerOfferNotif(offerNotif: FatCrabMakerNotifOfferStruct) { try! rustCall {
    ...
    open func onMakerPeerNotif(peerNotif: FatCrabMakerNotifPeerStruct) { try! rustCall {
...
private enum UniffiCallbackInterfaceFatCrabMakerNotifDelegate {
    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceFatCrabMakerNotifDelegate = .init(
        onMakerOfferNotif: { (
            uniffiHandle: UInt64,
            offerNotif: RustBuffer,
            _: UnsafeMutableRawPointer,
            uniffiCallStatus: UnsafeMutablePointer<RustCallStatus>
        ) in
            let makeCall = {
                () throws in
                guard let uniffiObj = try? FfiConverterTypeFatCrabMakerNotifDelegate.handleMap.get(handle: uniffiHandle) else {
                    throw UniffiInternalError.unexpectedStaleHandle
                }
                return try uniffiObj.onMakerOfferNotif(
                    offerNotif: FfiConverterTypeFatCrabMakerNotifOfferStruct.lift(offerNotif)
                )
            }
        ...
        onMakerPeerNotif: { (
            ...
            let makeCall = {
                ...
                return try uniffiObj.onMakerPeerNotif(
                    peerNotif: FfiConverterTypeFatCrabMakerNotifPeerStruct.lift(peerNotif)
                )
            }
        ...
        uniffiFree: { (uniffiHandle: UInt64) in
            let result = try? FfiConverterTypeFatCrabMakerNotifDelegate.handleMap.remove(handle: uniffiHandle)
            if result == nil {
                print("Uniffi callback interface FatCrabMakerNotifDelegate: handle missing in uniffiFree")
            }
        }
    )
}
...
private func uniffiCallbackInitFatCrabMakerNotifDelegate() {
    uniffi_fatcrab_trading_fn_init_callback_vtable_fatcrabmakernotifdelegate(&UniffiCallbackInterfaceFatCrabMakerNotifDelegate.vtable)
}

public struct FfiConverterTypeFatCrabMakerNotifDelegate: FfiConverter {
    fileprivate static var handleMap = UniffiHandleMap<FatCrabMakerNotifDelegate>()
...
open class FatCrabOfferEnvelope:
...
open class FatCrabOrderEnvelope:
    FatCrabOrderEnvelopeProtocol
{
    ...
    open func order() -> FatCrabOrder {
        return try! FfiConverterTypeFatCrabOrder.lift(try! rustCall {
...
open class FatCrabPeerEnvelope:
    FatCrabPeerEnvelopeProtocol
{
    ...
    open func message() -> FatCrabPeerMessage {
        return try! FfiConverterTypeFatCrabPeerMessage.lift(try! rustCall {
    ...
    FatCrabSellMakerProtocol
{
    ...
    open func notifyPeer(fatcrabTxid: String) throws -> FatCrabMakerState {
        return try FfiConverterTypeFatCrabMakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    FatCrabSellTakerProtocol
{
    ...
    open func releaseNotifyPeer() throws -> FatCrabTakerState {
        return try FfiConverterTypeFatCrabTakerState.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
...
open class FatCrabTakerNotifDelegateImpl:
    FatCrabTakerNotifDelegate
{
    ...
    open func onTakerPeerNotif(peerNotif: FatCrabTakerNotifPeerStruct) { try! rustCall {
    ...
    open func onTakerTradeRspNotif(tradeRspNotif: FatCrabTakerNotifTradeRspStruct) { try! rustCall {
...
// Put the implementation in a struct so we don't pollute the top-level namespace
private enum UniffiCallbackInterfaceFatCrabTakerNotifDelegate {
    // Create the VTable using a series of closures.
    // Swift automatically converts these into C callback functions.
    static var vtable: UniffiVTableCallbackInterfaceFatCrabTakerNotifDelegate = .init(
        onTakerPeerNotif: { (
            uniffiHandle: UInt64,
            peerNotif: RustBuffer,
            _: UnsafeMutableRawPointer,
            ...
            let makeCall = {
                () throws in
                guard let uniffiObj = try? FfiConverterTypeFatCrabTakerNotifDelegate.handleMap.get(handle: uniffiHandle) else {
                    throw UniffiInternalError.unexpectedStaleHandle
                }
                return try uniffiObj.onTakerPeerNotif(
                    peerNotif: FfiConverterTypeFatCrabTakerNotifPeerStruct.lift(peerNotif)
                )
            }
        ...
        onTakerTradeRspNotif: { (
            uniffiHandle: UInt64,
            tradeRspNotif: RustBuffer,
            _: UnsafeMutableRawPointer,
            uniffiCallStatus: UnsafeMutablePointer<RustCallStatus>
        ) in
            let makeCall = {
                ...
                return try uniffiObj.onTakerTradeRspNotif(
                    tradeRspNotif: FfiConverterTypeFatCrabTakerNotifTradeRspStruct.lift(tradeRspNotif)
                )
            }
        ...
        uniffiFree: { (uniffiHandle: UInt64) in
            let result = try? FfiConverterTypeFatCrabTakerNotifDelegate.handleMap.remove(handle: uniffiHandle)
            if result == nil {
                print("Uniffi callback interface FatCrabTakerNotifDelegate: handle missing in uniffiFree")
            }
        }
    )
}
...
private func uniffiCallbackInitFatCrabTakerNotifDelegate() {
    uniffi_fatcrab_trading_fn_init_callback_vtable_fatcrabtakernotifdelegate(&UniffiCallbackInterfaceFatCrabTakerNotifDelegate.vtable)
}

public struct FfiConverterTypeFatCrabTakerNotifDelegate: FfiConverter {
    fileprivate static var handleMap = UniffiHandleMap<FatCrabTakerNotifDelegate>()
...
open class FatCrabTradeRspEnvelope:
    FatCrabTradeRspEnvelopeProtocol
{
    ...
    open func tradeRsp() -> FatCrabTradeRsp {
        return try! FfiConverterTypeFatCrabTradeRsp.lift(try! rustCall {
    ...
    FatCrabTraderProtocol
{
    ...
    public static func newWithMnemonic(prodLvl: ProductionLevel, mnemonic: String, info: BlockchainInfo, appDirPath: String) -> FatCrabTrader {
        return try! FfiConverterTypeFatCrabTrader.lift(try! rustCall {
    ...
    open func addRelays(relayAddrs: [RelayAddr]) throws { try rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func getBuyMakers() -> [String: FatCrabBuyMaker] {
        return try! FfiConverterDictionaryStringTypeFatCrabBuyMaker.lift(try! rustCall {
            uniffi_fatcrab_trading_fn_method_fatcrabtrader_get_buy_makers(self.uniffiClonePointer(), $0)
        })
    }

    open func getBuyTakers() -> [String: FatCrabBuyTaker] {
        return try! FfiConverterDictionaryStringTypeFatCrabBuyTaker.lift(try! rustCall {
            uniffi_fatcrab_trading_fn_method_fatcrabtrader_get_buy_takers(self.uniffiClonePointer(), $0)
        })
    }

    open func getRelays() -> [RelayInfo] {
    ...
    open func getSellMakers() -> [String: FatCrabSellMaker] {
        return try! FfiConverterDictionaryStringTypeFatCrabSellMaker.lift(try! rustCall {
            uniffi_fatcrab_trading_fn_method_fatcrabtrader_get_sell_makers(self.uniffiClonePointer(), $0)
        })
    }

    open func getSellTakers() -> [String: FatCrabSellTaker] {
        return try! FfiConverterDictionaryStringTypeFatCrabSellTaker.lift(try! rustCall {
            uniffi_fatcrab_trading_fn_method_fatcrabtrader_get_sell_takers(self.uniffiClonePointer(), $0)
        })
    }

    open func newBuyMaker(order: FatCrabOrder, fatcrabRxAddr: String) throws -> FatCrabBuyMaker {
        return try FfiConverterTypeFatCrabBuyMaker.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func newBuyTaker(orderEnvelope: FatCrabOrderEnvelope) throws -> FatCrabBuyTaker {
        return try FfiConverterTypeFatCrabBuyTaker.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func newSellMaker(order: FatCrabOrder) throws -> FatCrabSellMaker {
        return try FfiConverterTypeFatCrabSellMaker.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func newSellTaker(orderEnvelope: FatCrabOrderEnvelope, fatcrabRxAddr: String) throws -> FatCrabSellTaker {
        return try FfiConverterTypeFatCrabSellTaker.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func nostrPubkey() -> String {
        return try! FfiConverterString.lift(try! rustCall {
            uniffi_fatcrab_trading_fn_method_fatcrabtrader_nostr_pubkey(self.uniffiClonePointer(), $0)
        })
    }

    open func queryOrders(orderType: FatCrabOrderType?) throws -> [FatCrabOrderEnvelope] {
        return try FfiConverterSequenceTypeFatCrabOrderEnvelope.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
    ...
    open func reconnect() throws { try rustCallWithError(FfiConverterTypeFatCrabError.lift) {
        uniffi_fatcrab_trading_fn_method_fatcrabtrader_reconnect(self.uniffiClonePointer(), $0)
    }
    }

    open func removeRelay(url: String) throws { try rustCallWithError(FfiConverterTypeFatCrabError.lift) {
        uniffi_fatcrab_trading_fn_method_fatcrabtrader_remove_relay(self.uniffiClonePointer(),
                                                                    FfiConverterString.lower(url), $0)
    }
    }

    open func shutdown() throws { try rustCallWithError(FfiConverterTypeFatCrabError.lift) {
        uniffi_fatcrab_trading_fn_method_fatcrabtrader_shutdown(self.uniffiClonePointer(), $0)
    }
    }

    open func walletBalances() throws -> Balances {
        return try FfiConverterTypeBalances.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabtrader_wallet_balances(self.uniffiClonePointer(), $0)
        })
    }

    open func walletBip39Mnemonic() throws -> String {
        return try FfiConverterString.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabtrader_wallet_bip39_mnemonic(self.uniffiClonePointer(), $0)
        })
    }

    open func walletBlockchainHeight() throws -> UInt32 {
        return try FfiConverterUInt32.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabtrader_wallet_blockchain_height(self.uniffiClonePointer(), $0)
        })
    }

    open func walletBlockchainSync() throws { try rustCallWithError(FfiConverterTypeFatCrabError.lift) {
        uniffi_fatcrab_trading_fn_method_fatcrabtrader_wallet_blockchain_sync(self.uniffiClonePointer(), $0)
    }
    }

    open func walletGenerateReceiveAddress() throws -> String {
        return try FfiConverterString.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
            uniffi_fatcrab_trading_fn_method_fatcrabtrader_wallet_generate_receive_address(self.uniffiClonePointer(), $0)
        })
    }

    open func walletSendToAddress(address: String, amount: UInt64) throws -> String {
        return try FfiConverterString.lift(rustCallWithError(FfiConverterTypeFatCrabError.lift) {
...
public struct Balances {
    ...
    public init(immature: UInt64, trustedPending: UInt64, untrustedPending: UInt64, confirmed: UInt64, allocated: UInt64) {
...
public struct FatCrabOrder {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(orderType: FatCrabOrderType, tradeUuid: String, amount: Double, price: Double) {
...
public struct FatCrabPeerMessage {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(receiveAddress: String, txid: String) {
...
public struct FfiConverterTypeAuth: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Auth {
        ...
        case 2: return try .userPass(username: FfiConverterString.read(from: &buf), password: FfiConverterString.read(from: &buf))

        case 3: return try .cookie(file: FfiConverterString.read(from: &buf)
            )
...
public enum BlockchainInfo {
    case electrum(url: String, network: Network)
    case rpc(url: String, auth: Auth, network: Network)
}
...
public struct FfiConverterTypeBlockchainInfo: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> BlockchainInfo {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .electrum(url: FfiConverterString.read(from: &buf), network: FfiConverterTypeNetwork.read(from: &buf))

        case 2: return try .rpc(url: FfiConverterString.read(from: &buf), auth: FfiConverterTypeAuth.read(from: &buf), network: FfiConverterTypeNetwork.read(from: &buf))
...
public enum FatCrabError {
    case TxNotFound
    case TxUnconfirmed
    case Simple(description: String
    )
    case N3xb(description: String
    )
    case BdkBip39(description: String
    )
    case Bdk(description: String
    )
...
public enum FatCrabTradeRsp {
    case accept(receiveAddress: String
    )
    case reject
}
...
public struct FfiConverterTypeFatCrabTradeRsp: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> FatCrabTradeRsp {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        case 1: return try .accept(receiveAddress: FfiConverterString.read(from: &buf)
            )
...
public func initTracingForOslog(level: FilterLevel, logTimestamp: Bool, logLevel: Bool) { try! rustCall {
...
private var initializationResult: InitializationResult {
    ...
    if uniffi_fatcrab_trading_checksum_constructor_fatcrabtrader_new() != 52667 {
        return InitializationResult.apiChecksumMismatch
    }
    if uniffi_fatcrab_trading_checksum_constructor_fatcrabtrader_new_with_mnemonic() != 60569 {
        return InitializationResult.apiChecksumMismatch
    }
